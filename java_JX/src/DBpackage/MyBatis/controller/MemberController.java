package DBpackage.MyBatis.controller;

import java.util.ArrayList;
import java.util.Scanner;

import DBpackage.MyBatis.model.vo.MemberVO;
import DBpackage.MyBatis.service.MemberService;
import DBpackage.MyBatis.service.MemberServiceImp;
...
public class MemberController {
	...
	private void insertMember() {
		...
		if(memberService.insertMember(member)) {
			...
			System.out.println("회원추가에 실패했습니다.");
		}
