...
<div>
	...
	<div class="contaier-comment mt-3 mb-3">
		...
		<div class="box-comment-insert">
		  <div class="input-group mb-3">
	    	<textarea rows="" cols="" class="form-control textarea-comment"></textarea>
...
<script type="text/javascript">
	...
	function getCommentList(cri){
		$.ajax({
			...
			contentType : "application/json; charset=utf-8",	// 서버로 보낼데이터의 타입
...
<script type="text/javascript">
	...
	// 로그인 한 회원의 추천/비추천 여부와 게시글의 추천/비추천 수를 가져오는 메서드
